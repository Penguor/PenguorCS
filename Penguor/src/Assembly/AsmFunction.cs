...
namespace Penguor.Compiler.Assembly
{
    public class AsmFunctionAmd64 : IEmitter
    {
        ...
        public List<AsmInstructionAmd64> Instructions { get; }
        ...
        public void InsertInstruction(int index, AsmMnemonicAmd64 opCode, params AsmOperand[] operands) => Instructions.Insert(index, new AsmInstructionAmd64(opCode, operands));
